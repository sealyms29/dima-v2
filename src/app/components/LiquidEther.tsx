...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      mouse: any;
      constructor(simProps: any) {
        super({ output: simProps.dst }); this.initEF(simProps);
      }
      initEF(simProps: any) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      update(p: any) {
        ...
        for (let i = 0; i < p.iterations; i++) {
          ...
          this.props.output = fbo_out; this.uniforms.dt.value = p.dt; super.update();
        }
        return fbo_out;
      }
    }
    ...
    class Simulation {
      ...
      update() {
        ...
        this.divergence.update({ vel }); const pr = this.poisson.update({ iterations: this.options.iterations_poisson }); this.pressure.update({ vel, pressure: pr });
      }
    }

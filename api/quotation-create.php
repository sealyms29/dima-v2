 ...
 */
function send_quotation_notification($name, $email, $company, $message) {
    // This is optional - implement if needed with your email service
    // You can use:
    // - PHP mail() function
    // - PHPMailer library
    ...
    // Example using mail():
    /*
    $subject = "New Quotation Request - " . htmlspecialchars($company ?: 'N/A');
    $body = "New quotation submission received:\n\n";
